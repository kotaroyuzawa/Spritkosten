...
/*
if ((empty($amount1) && !empty($cost1)) ||
    (!empty($amount1) && empty($cost1)) ||
    (empty($amount2) && !empty($cost2)) ||
    (!empty($amount2) && empty($cost2)) ||
    (empty($amount3) && !empty($cost3)) ||
    (!empty($amount3) && empty($cost3)) ||
    (empty($amount4) && !empty($cost4)) ||
    (!empty($amount4) && empty($cost4)) ||
    (empty($amount1) && empty($amount2) && empty($amount3) && empty($amount4) && empty($cost1) && empty($cost2) && empty($cost3) && empty($cost4)))
*/
